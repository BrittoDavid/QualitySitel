...
<div class="right_col" role="main">
  <div class="">
    <div class="row top_tiles">
      ...
      <!--FORMULARIO-->
      <div class="container">
        <h3 class="box-title">Incident Tracker (Update)</h3>
        <form action="{{url('adp/updateTrackerPost')}}" method="POST">
          @csrf
          <div class="row">
            ...
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                     <input type="text" value="{{$tra[0]->id_tracker}}" style="height: 28px; width: 200px;" disabled/>
                     <input type="hidden" value="{{$tra[0]->id_tracker}}" name="id_tracker">
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                     <input type="date" value="{{$tra[0]->call_date}}" name="call_date" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                     <input type="text" value="{{$tra[0]->call_time}}" id="time" placeholder="H:M:S"  name="call_time" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                     <input type="text" value="{{$tra[0]->call_length}}" name="call_length" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="number" value="{{$tra[0]->call_id}}" name="call_id"  style="height: 28px; width: 200px;" required/>
                    </div>
                </div>
              </center>
            </div>            
            <div class="col-md-6">
              <center>
                <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="date" value="{{$tra[0]->date_received}}" name="date_received" style="height: 28px; width: 200px;" required/>
                    </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="date" value="{{$tra[0]->date_answered}}" name="date_answered" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                     <input type="text" value="{{$tra[0]->received_from}}" name="received_from" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                     <input type="text" value="{{$tra[0]->lob_product}}" name="lob_product" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->csp}}" name="csp" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="number" value="{{$tra[0]->adp_lawson}}" name="adp_lawson" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->what_incident}}" name="what_incident" style="height: 50px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->correct_incident}}" name="correct_incident" style="height: 50px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->call_synopsis}}" name="call_synopsis" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->findings}}" name="findings" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            ...
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->reason_for_validity}}" name="reason_for_validity" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->reason_for_contact}}" name="reason_for_contact" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            ...
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->finantial_impact}}" name="finantial_impact" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            ...
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->area_opportunity}}" name="area_opportunity" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            ...
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="number"  name="user_id" value="{{$tra[0]->user_id}}" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            ...
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->qa_sub_section_impacted}}" name="qa_sub_section_impacted" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" value="{{$tra[0]->secondary_qa_sub_section_impacted}}" name="secondary_qa_sub_section_impacted" style="height: 48px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" placeholder="(USA) $" name="amount_finantial_impact" value="{{$tra[0]->amount_finantial_impact}}" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            ...
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" name="qa_assigned" value="{{$tra[0]->qa_assigned}}" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" name="employee_role" value="{{$tra[0]->employee_role}}" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" name="wave" value="{{$tra[0]->wave}}" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" name="immediate_supervisor" value="{{$tra[0]->immediate_supervisor}}" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" name="operations_manager" value="{{$tra[0]->operations_manager}}" style="height: 28px; width: 200px;" required/>
                  </div>
                </div>
              </center>
            </div>
            <div class="col-md-6">
              <center>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" name="agent_status" value="{{$tra[0]->agent_status}}" style="height: 28px; width: 205px;" required/>
                  </div>
                </div>
              </center>
            </div>
