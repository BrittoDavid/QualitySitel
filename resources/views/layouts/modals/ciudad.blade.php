        ...
        <form action="#" id="form_ciudad" method="get"  enctype="multipart/form-data">
          <div class="body"><br><br><br>
            ...
            <div class="row clearfix">
              ...
              <center>                 
                <a class="btn btn-success" href="#" onclick="registrarCiudad()" id="boton_ciudad" data-url="/funciones/registrarciu"><img  id="esperar1" width="20em" src="{{ asset('img/cargando/4.gif') }}" style="display: none"> Registrar Ciudad</a>
              </center>
            </div>
          </div>  
        </form> 
